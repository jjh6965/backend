...
public class DbWorkHistoryController {
    private static final Logger logger = LoggerFactory.getLogger(DbWorkHistoryController.class);
    ...
    @CommonApiResponses
    @PostMapping("/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> dbWorkHistoryList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "MONTHLYDBWORK";
        String jobGb = "GET";
