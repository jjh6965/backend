...
@RestController
@RequestMapping("api/history/dbfileworkhistory") // 변경: 상위 경로 통합
...
public class DbFileWorkHistoryController {
    private static final Logger logger = LoggerFactory.getLogger(DbFileWorkHistoryController.class);
    ...
    @CommonApiResponses
    @PostMapping("/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> dbFileWorkHistoryList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "MONTHLYDBFILEWORK";
        String jobGb = "GET";
        ...
        pMDATE = pMDATE != null ? pMDATE.replace("-", "") : "202505"; // YYYYMM 형식으로 변환
