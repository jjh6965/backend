...
@RestController("operLoginHistoryController")
@RequestMapping("api/oper/loginHistory")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "3.시스템관리 > 월별 로그인이력", description = "월별 로그인이력을 확인하는 API")
public class LoginHistoryController {
    ...
    @CommonApiResponses
    @PostMapping("/save")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> LoginHistorySave(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "LOGINHISTUSERINFO";
